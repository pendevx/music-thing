...
export default function MusicProgressBar(args) {
    function MusicProgressBarComponent({ songDurationSecs, currentTime = 0, onFastForward }) {
    ...
    return <MusicProgressBarComponent {...args} />;
}
