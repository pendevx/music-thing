...
export default function MusicShuffle({ className }: MusicShuffleProps) {
    return (
        <svg width="800px" height="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={`h-full w-auto bg-transparent ${className}`}>
